                            ...
                            <tbody>
                                <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b hover:bg-slate-50">
                                        <td class="px-3 py-2 font-semibold text-slate-700"><?php echo e($module->name); ?></td>
                                        <?php $__currentLoopData = ['view', 'create', 'edit', 'delete', 'status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                $permission = $module->permissions->where('slug', $module->slug . '.' . $action)->first();
                                            ?>
                                            <td class="px-3 py-2 text-center">
                                                <?php if($permission): ?>
                                                    <input type="checkbox" name="permissions[<?php echo e($permission->id); ?>]" value="1"
...
<?php $__env->startPush('scripts'); ?>
    <script>
        let table;
        const canEdit = <?php echo e(hasPermission('roles.edit') ? 'true' : 'false'); ?>;
        const canDelete = <?php echo e(hasPermission('roles.delete') ? 'true' : 'false'); ?>;
        const canStatus = <?php echo e(hasPermission('roles.status') ? 'true' : 'false'); ?>;
        ...
        function openEditModal(id, name, status, description) {
            ...
            // Load Permissions
            $.get(`<?php echo e(url('roles/permissions')); ?>/${id}`, function (permissions) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u363423261/domains/careerguard.in/public_html/resources/views/roles/index.blade.php ENDPATH**/ ?>