            ...
            <div class="container z-10">
                <div class="flex flex-wrap mt-0 -mx-3">
                                ...
                                <form method="POST" action="<?php echo e(route('login')); ?>" role="form">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <?php if ($errors->has('email')): ?>
                                            <p class="text-red-500 text-xs mt-1"><?php echo e($errors->first('email')); ?>
                                            </p>
                                        <?php endif; ?>
                                    </div>
                    ...
                    <div class="w-full max-w-full px-3 lg:flex-0 shrink-0 md:w-6/12">
                      ...
                      background-image: url('<?php echo e(asset('assets/img/curved-images/curved6.jpg')); ?>');
                    "></div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u363423261/domains/careerguard.in/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>