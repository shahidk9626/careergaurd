        ...
        <nav>
            ...
            <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                ...
                <li class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']"
                    aria-current="page">
                    <?php echo e(ucfirst(request()->path())); ?>

                </li>
            </ol>
            <h6 class="mb-0 font-bold capitalize"><?php echo e(ucfirst(request()->path())); ?></h6>
        </nav>
        ...
        <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
            ...
            <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                ...
                <li class="flex items-center">
                    <!-- <a href="<?php echo e(route('profile.edit')); ?>" class="block px-0 py-2 font-semibold transition-all ease-nav-brand text-sm text-slate-500"> -->
...
<!-- end Navbar --><?php /**PATH /Users/Raif/Documents/GitHub/careergaurd/resources/views/partials/header.blade.php ENDPATH**/ ?>