        ...
        <div class="flex-none w-full max-w-full px-3">
            <div
                ...
                <div class="flex-auto p-6">
                    ...
                    <form id="customerForm" action="<?php echo e(route('customer.store-profile')); ?>" method="POST"
                                ...
                                <div class="flex flex-wrap -mx-3">
                                    <div class="w-full max-w-full px-3 mb-4 md:w-1/2">
                                        ...
                                        <input type="text" name="whatsapp_number"
                                            value="<?php echo e(auth()->user()->whatsapp_number); ?>" required
                                            class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" />
                                    </div>
                                    <div class="w-full max-w-full px-3 mb-4 md:w-1/2">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/Raif/Documents/GitHub/careergaurd/resources/views/customer/registration.blade.php ENDPATH**/ ?>