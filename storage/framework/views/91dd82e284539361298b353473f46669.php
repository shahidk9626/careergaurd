                        ...
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                ...
                                <h5 class="mb-0 font-bold">
                                    <?php echo e(number_format($totalActiveCustomers)); ?>
                    ...
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                ...
                                <h5 class="mb-0 font-bold">
                                    <?php echo e(number_format($totalPlansPurchased)); ?>
                    ...
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                ...
                                <h5 class="mb-0 font-bold">
                                    ₹ <?php echo e(number_format($totalPurchasedAmount, 0, '.', ',')); ?>
                    ...
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                ...
                                <h5 class="mb-0 font-bold">
                                    <?php echo e(number_format($totalActiveStaff)); ?>
                    ...
                    <div class="flex flex-wrap -mx-3">
                        ...
                        <div class="max-w-full px-3 mt-12 ml-auto text-center lg:mt-0 lg:w-5/12 lg:flex-none">
                            <div class="h-full bg-gradient-to-tl from-purple-700 to-pink-500 rounded-xl">
                                <img src="<?php echo e(asset('assets/img/shapes/waves-white.svg')); ?>"
                                    class="absolute top-0 hidden w-1/2 h-full lg:block" alt="waves" />
                                <div class="relative flex items-center justify-center h-full">
                                    <img class="relative z-20 w-full pt-6"
                                        src="<?php echo e(asset('assets/img/illustrations/rocket-white.png')); ?>" alt="rocket" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
            <div
                ...
                <div class="relative h-full overflow-hidden bg-cover rounded-xl"
                    style="background-image: url('<?php echo e(asset('assets/img/ivancik.jpg')); ?>')">
                    <span
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('assets/js/chart-1.js')); ?>" async></script>
    <script src="<?php echo e(asset('assets/js/chart-2.js')); ?>" async></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/Raif/Documents/GitHub/careergaurd/resources/views/dashboard.blade.php ENDPATH**/ ?>