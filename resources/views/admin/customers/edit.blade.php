                            ...
                            <div class="mb-8 p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                ...
                                <div class="flex flex-wrap -mx-3">
                                    <div class="w-full max-w-full px-3 mb-4 md:w-1/2">
                                        ...
                                        <input type="text" name="name" value="{{ $customer->name }}" required placeholder="Enter customer name"
                                    ...
                                    <div class="w-full max-w-full px-3 mb-4 md:w-1/2">
                                        <label class="mb-2 ml-1 font-bold text-xs text-slate-700">WhatsApp Number <span
                                                class="text-red-500">*</span></label>
                                        <input type="text" name="whatsapp_number" value="{{ $customer->whatsapp_number }}" required
                            ...
                            <div class="mb-8 p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                ...
                                <div class="flex flex-wrap -mx-3">
                                    <div class="w-full max-w-full px-3 mb-4 md:w-1/2">
                                        ...
                                        <input type="text" name="father_name" value="{{ $customer->customerDetail->father_name ?? '' }}" placeholder="Enter father's name"
                                            class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all focus:border-fuchsia-300 focus:outline-none" />
                                    </div>
                                    <div class="w-full max-w-full px-3 mb-4 md:w-1/2">
                            ...
                            <div class="mb-8 p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                ...
                                <div class="flex flex-wrap -mx-3">
                                    ...
                                    <div class="w-full max-w-full px-3 mb-4 md:w-1/3">
                                        ...
                                        <input type="text" name="pincode" value="{{ $customer->customerDetail->pincode ?? '' }}" placeholder="Pincode"
                                            class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all focus:border-fuchsia-300 focus:outline-none" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-8 p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                ...
                                <div class="flex flex-wrap -mx-3">
                                    ...
                                    <div class="w-full max-w-full px-3 mb-4 md:w-1/2">
                                        ...
                                        <input type="text" name="account_number" value="{{ $customer->customerDetail->account_number ?? '' }}" placeholder="Account Number"
                                            class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all focus:border-fuchsia-300 focus:outline-none" />
                                    </div>
                                    <div class="w-full max-w-full px-3 mb-4 md:w-1/2">
                                        <label class="mb-2 ml-1 font-bold text-xs text-slate-700">PAN Number</label>
                                        <input type="text" name="pan_number" value="{{ $customer->customerDetail->pan_number ?? '' }}" placeholder="PAN Number"
                                            class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all focus:border-fuchsia-300 focus:outline-none" />
                                    </div>
                                    <div class="w-full max-w-full px-3 mb-4 md:w-1/2">
                                        <label class="mb-2 ml-1 font-bold text-xs text-slate-700">Aadhar Number</label>
                                        <input type="text" name="aadhar_number" value="{{ $customer->customerDetail->aadhar_number ?? '' }}" placeholder="Aadhar Number"
                                            class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all focus:border-fuchsia-300 focus:outline-none" />
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-4 doc-row items-end">
                                        <div class="w-full max-w-full px-3 md:w-5/12">
                                            <input type="text" name="document_names[]" placeholder="Document Name"
                                                class="validate-doc-name focus:shadow-soft-primary-outline text-sm block w-full rounded-lg border border-solid border-gray-300 bg-white px-3 py-2 font-normal text-gray-700" />
                                        </div>
                                        <div class="w-full max-w-full px-3 md:w-5/12">
                                            <input type="file" name="documents[]"
                                                class="validate-file focus:shadow-soft-primary-outline text-sm block w-full rounded-lg border border-solid border-gray-300 bg-white px-3 py-1 font-normal text-gray-700" />
                                        </div>
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            let validator = $("#adminCustomerForm").validate({
                rules: {
                    name: { required: true, lettersnspaces: true, minlength: 3 },
                    email: { required: true, email: true },
                    whatsapp_number: { required: true, indianmobile: true },
                    father_name: { lettersnspaces: true, minlength: 3 },
                    dob: { pastdate: true },
                    city: { lettersnspaces: true },
                    state: { lettersnspaces: true },
                    pincode: { pincode_custom: true },
                    pan_number: { pan: true },
            ...
            $('#addDocRow').on('click', function () {
                $('#documentRows').append(`
                        <div class="flex flex-wrap -mx-3 mb-4 doc-row items-end">
                            <div class="w-full max-w-full px-3 md:w-5/12"><input type="text" name="document_names[]" placeholder="Document Name" class="validate-doc-name focus:shadow-soft-primary-outline text-sm block w-full rounded-lg border border-solid border-gray-300 bg-white px-3 py-2 font-normal text-gray-700" /></div>
                            <div class="w-full max-w-full px-3 md:w-5/12"><input type="file" name="documents[]" class="validate-file focus:shadow-soft-primary-outline text-sm block w-full rounded-lg border border-solid border-gray-300 bg-white px-3 py-1 font-normal text-gray-700" /></div>
